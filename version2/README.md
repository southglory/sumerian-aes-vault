...
We added pickle serialization, zlib compression, and base64 encoding into cypher map dictionary table.
...
python sumerian.py decrypt {encrypted password} qwerty1234
```
